...
// If you claimed "Wordle", replace everything in this file with your game.
    ...
    <div className="mx-auto max-w-md py-12">
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">{"Six guesses to find the five-letter word."}</p>
          <p>🚧 This game hasn&apos;t been built yet.</p>
          <p>
            The full spec — objective, rules, required features and definition of done — lives in
            issue #18. Claim it, then replace this file with your game.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href={issueUrl(18)}>Read the full spec (issue #18)</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
