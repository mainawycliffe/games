...
// If you claimed "Snakes and Ladders", replace everything in this file with your game.
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between gap-2">
            <CardTitle>Snakes and Ladders</CardTitle>
            <Badge variant="secondary">medium</Badge>
          </div>
        </CardHeader>
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">
            {"Roll, climb ladders, dodge snakes to the finish."}
          </p>
