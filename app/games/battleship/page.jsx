...
// If you claimed "Battleship", replace everything in this file with your game.
      ...
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">
            {"Sink the hidden fleet by calling coordinates."}
          </p>
          <p>🚧 This game hasn&apos;t been built yet.</p>
          <p>
            The full spec — objective, rules, required features and definition of done — lives in
            issue #24. Claim it, then replace this file with your game.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href={issueUrl(24)}>Read the full spec (issue #24)</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
