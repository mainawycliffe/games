...
// If you claimed "Tower of Hanoi", replace everything in this file with your game.
      ...
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">
            {"Move the stack to the last peg, one disc at a time."}
          </p>
          <p>🚧 This game hasn&apos;t been built yet.</p>
          <p>
            The full spec — objective, rules, required features and definition of done — lives in
            issue #11. Claim it, then replace this file with your game.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href={issueUrl(11)}>Read the full spec (issue #11)</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
