...
// If you claimed "Guess the Number", replace everything in this file with your game.
      ...
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">
            {"Higher or lower until you find the secret number."}
          </p>
          <p>🚧 This game hasn&apos;t been built yet.</p>
          <p>
            The full spec — objective, rules, required features and definition of done — lives in
            issue #6. Claim it, then replace this file with your game.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href={issueUrl(6)}>Read the full spec (issue #6)</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
