...
// If you claimed "Match 3", replace everything in this file with your game.
    ...
    <div className="mx-auto max-w-md py-12">
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">{"Swap gems to line up three or more."}</p>
          <p>🚧 This game hasn&apos;t been built yet.</p>
          <p>
            The full spec — objective, rules, required features and definition of done — lives in
            issue #48. Claim it, then replace this file with your game.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href={issueUrl(48)}>Read the full spec (issue #48)</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
