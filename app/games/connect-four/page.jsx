...
// If you claimed "Connect Four", replace everything in this file with your game.
    ...
    <div className="mx-auto max-w-md py-12">
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4 text-sm">
          <p className="text-foreground text-base">{"Drop discs; first to four-in-a-row wins."}</p>
